...
$(document).ready(function () {
    ...
    $.ajax({
        url: "http://173.249.20.156:8080/minimarket/rest/productos/qry2/" + idcategoria,
        dataType: "json",
        type: "GET",
            ...
            if (result.ok) {
                ...
                for (let i = 0; i < result.productos.length; ++i) {
                    ...
                    qry += "<div style=\"position:fixed;top:200px;left:0px;margin-left:-11px\">" +
                            ...
                            "</div>" +
                            "<img src=\"http://173.249.20.156:8080/minimarket/rest/productos/foto/" + result.productos[i][0] + "\" " +
...
function imageZoom(idproducto) {
    let obj = "<img src=\"http://173.249.20.156:8080/minimarket/rest/productos/foto/" + idproducto + "\" " +
...
function carritoAddItem(idproducto) {
    ...
    let msg = "<div class=\"row\">" +
            ...
            "<div class=\"col-4\"><img src=\"http://173.249.20.156:8080/minimarket/rest/productos/foto/" + idproducto + "\" style=\"height: 100px\"></div>" +
            "</div>";
