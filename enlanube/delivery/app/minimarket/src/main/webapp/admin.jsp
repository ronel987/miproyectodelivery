                        ...
                        <div class="row">
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-12 text-center">
                                    <img src="images/store.png" alt="" style="vertical-align: bottom; width: 450px">
                                    <i class="bi-c-circle"></i> Copyright a <a href="#" target="_blank" title="mini market" class="parainfo">Mini Market Serfer</a> 
                                    <br><i class="bi-bookmark-star"></i> Auspiciado por <a href="http://www.chiclayo-hotelcentral.com" target="_blank" title="Hotel Central" class="parainfo">chiclayo-hotelcentral.com</a> 
                                </div>
                            </div>
                        </div>
                    </form>
