...
public class Autentica {
    ...
    public Response autentica(@HeaderParam("user") String user) {
    ...
    @Consumes(MediaType.TEXT_PLAIN)
    @Produces(MediaType.APPLICATION_JSON)
    public Response validaToken(  @QueryParam("token") String token, @QueryParam("autorizacion") String autorizacion) {
