$(function () {
    ...
    $("#ajax_wait").show();
    $.ajax({
        url: "http://localhost:8080/delivery/rest/categorias/search",
        dataType: "json",
        type: "GET",
...
function categoriasQry(carga) {
    ...
    $("#ajax_wait").show();
    $.ajax({
        url: "http://localhost:8080/delivery/rest/categorias/qry",
        dataType: "json",
        type: "GET",
        data: {
            numPag: pagActual - 1,
            ...
            if (result.hasOwnProperty("msg")) {
                ...
                for (let i = 0; i < result.rows.length; ++i) {
                    ...
                    qry += "<tr id=\"" + result.rows[i].idcategoria + "\">" +
                            ...
                            "</td>" +
                            "<td class=\"col-3\">" +
                            "<img src=\"http://localhost:8080/delivery/rest/categorias/foto/" + result.rows[i].idcategoria + "\" " + "alt=\"\" style=\"max-height: 50px\">" +
                            "</td>" +
...
function categoriasGet() {
    ...
    $.ajax({
        url: "http://localhost:8080/delivery/rest/categorias/get/" + idcategoria,
        dataType: "json",
        type: "GET",
        success: function (result) { //alert(JSON.stringify(result));
            if (result.ok) {
                ...
                $("#dlg_categorias_imagen_view").html("<img src=\"http://localhost:8080/delivery/rest/categorias/foto/" + result.categorias.idcategoria + "\" " + "alt=\"\" style=\"max-height: 50px\">");
...
function categoriasInsUpd() {
    ...
    $.ajax({
        url: "http://localhost:8080/delivery/rest/categorias/insUpd",
        dataType: "json",
        type: "POST",
        contentType: false,
        processData: false,
...
function dlg_confirm_confirm() {
    ...
    if (accion === "DEL") {
        $.ajax({
            url: "http://localhost:8080/delivery/rest/categorias/del/" + ids,
            type: "DELETE",
