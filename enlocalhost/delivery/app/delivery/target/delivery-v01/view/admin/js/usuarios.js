$(function () {
    ...
    $.ajax({
        url: "http://localhost:8080/delivery/rest/usuarios/search",
        dataType: "json",
        type: "GET",
...
function usuariosQry(carga) {
    ...
    $.ajax({
        url: "http://localhost:8080/delivery/rest/usuarios/qry",
        dataType: "json",
        type: "GET",
        data: {
            numPag: pagActual - 1,
...
function usuariosGet() {
    ...
    $.ajax({
        url: "http://localhost:8080/delivery/rest/usuarios/get/" + idusuario,
        dataType: "json",
        type: "GET",
        success: function (result) { // alert(JSON.stringify(result));
...
function usuariosInsUpd() {
    ...
    // consume servicios
    let url = accion === "INS"
            ? "http://localhost:8080/delivery/rest/usuarios/ins"
            : "http://localhost:8080/delivery/rest/usuarios/upd";
...
function dlg_confirm_confirm() {
    ...
    if (accion === "DEL") {
        $.ajax({
            url: "http://localhost:8080/delivery/rest/usuarios/del/" + ids,
            type: "DELETE",
            success: function (result) {
                if (!result.ok) {
